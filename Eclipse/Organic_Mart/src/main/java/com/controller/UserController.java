	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			
		{
			...
			if(user.getPassword().equals(request.getParameter("old_password")))
			{
				if(request.getParameter("new_password").equals(request.getParameter("cnew_password"))) 
				{
					...
					else
					{
						if(user.getUsertype().equals("buyer")) 
						{
							request.setAttribute("msg", "Old Password And New Password Must Be Different");
				...
				else
				{
					if(user.getUsertype().equals("buyer"))
					{
						request.setAttribute("msg", "New Password And Confirm New Password Doses Not Matched");
						request.getRequestDispatcher("change-password.jsp").forward(request, response);
					}
					else
					{
			...
			else
			{
				if(user.getUsertype().equals("buyer"))
				{
					request.setAttribute("msg", "Old Password Doses Not Matched");
					request.getRequestDispatcher("change-password.jsp").forward(request, response);
